...
CREATE TYPE cust_type_cds AS ENUM('I','B')

create table customer
 (cust_id serial not null,
  fed_id varchar(12) not null,
  cust_type_cd cust_type_cds not null,
  address varchar(30),
  city varchar(20),
  state varchar(20),
...
CREATE TYPE statuses AS ENUM('ACTIVE','CLOSED','FROZEN')
...
CREATE TYPE txn_type_cds AS ENUM('DBT','CDT')

create table transaction
 (txn_id serial not null,
  txn_date timestamp not null,
  account_id integer not null,
  txn_type_cd txn_type_cds,
